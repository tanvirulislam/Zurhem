...
class ProductController extends Controller
{
    ...
    {
       return FeatureProductResource::collection(Product::where('status',2)->latest()->limit(6)->paginate(2));
    }
    ...
    {
       return CatProductResource::collection(Product::where('category_slug',$slug)->latest()->paginate(5));
    }
...
public function product_detail($id){
    ...
    //dd($slug);
        ...
        $cat_name_value = Product::where('id', $id)->value('category_slug');
        $main_cat_name_value = Category::where('category_slug', $cat_name_value)->value('name');

        $sub_cat_name_value = Product::where('id', $id)->value('subcategory_slug');
